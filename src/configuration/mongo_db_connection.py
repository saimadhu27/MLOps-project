...
class MongoDBClient:
    ...
    def __init__(self, database_name: str = DATABASE_NAME) -> None:
        """
        Initializes a connection to the MongoDB databse. If no existing connection is found, it establishes a new one.
        
        Parameters:
        -----------
        database_name : str, optinal
        ...
        try:
            ...
            if MongoDBClient.client is None:
                ...
                if mongo_db_url is None:
                    raise Exception(f"Environment vairable '{MONGODB_URL_KEY}' is not set.")
