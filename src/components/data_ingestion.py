...
class DataIngestion:
    ...
    def export_data_into_feature_store(self) -> pd.DataFrame:
        ...
        Returns:
            pd.DataFrame: data is returned as artifact of data ingestion components
        """
        try:
            logging.info("Exporting data from mongodb")
            # creating object for class Proj1Data and calling its method
            my_data = Proj1Data()
    ...
    def initiate_data_ingestion(self) -> DataIngestionArtifact:
        ...
        Returns:
            DataIngestionArtifact: train set and test set are returned as the artifacts of data ingestion components
        """
