...
class DataValidation:
    def __init__(self, data_ingestion_artifact: DataIngestionArtifact, data_validation_config: DataValidationConfig):
        """
        Args:
            data_ingestion_artifact (_type_): Output reference of data ingestion artifact stage
            data_validation_config (_type_): configuration for data validation
        """
        try:
    ...
    def validate_number_of_columns(self, dataframe : pd.DataFrame) -> bool:
        ...
        Args:
            dataframe (pd.DataFrame): train or test dataframe

        Returns:
            bool: Returns bool value based on validation results
        """
        try:
    ...
    def initiate_data_validation(self) -> DataValidationArtifact:
        ...
        Returns:
            DataValidationArtifact: Returns bool value based on validation results
        """
        try:
